    ...
    public class Attack : MonoBehaviour
    {
        ...
        void OnButtonClick()
        {
            ...
            if (true)//如果计时大于子弹的发射速率（rate每秒几颗子弹）  
            {
                ...
                bullet2.GetComponent<Rigidbody>().AddForce(bullet2.transform.forward * 5000);
                //bullet2.GetComponent<ETFXProjectileScript>().impactNormal = hit.normal;
                Destroy(bullet2, 5);//在10S后销毁子弹   
                                    // timer = 0;//时间清零  
                                    */
            }
        }
